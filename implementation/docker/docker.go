/*
Package dockerimplementation the custom implementation that supports components interacting with Docker.
*/
...
type DockerImplementation interface {
	...
	Version(ctx context.Context) (map[string]dockertypesswarm.Version, error)
	...
	NodeList(ctx context.Context, options dockertypesswarm.NodeListOptions) ([]dockertypesswarm.Node, error)
