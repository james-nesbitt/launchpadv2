...
type Config struct {
	...
	InstallFlags        flags.Flags `yaml:"installFlags,omitempty,flow"`
	SwarmInstallFlags   flags.Flags `yaml:"swarmInstallFlags,omitempty,flow"`
	SwarmUpdateCommands []string    `yaml:"swarmUpdateCommands,omitempty,flow"`
	UpgradeFlags        flags.Flags `yaml:"upgradeFlags,omitempty,flow"`
