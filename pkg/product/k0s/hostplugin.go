...
func (mpf *HostPluginFactory) Plugin(_ context.Context, h *host.Host) host.HostPlugin {
	p := &hostPlugin{
		h:           h,
		Environment: map[string]string{},
>>>>>>> 4c9c75b (initial configurer)
	}
...
func (mpf *HostPluginFactory) Decode(_ context.Context, h *host.Host, d func(interface{}) error) (host.HostPlugin, error) {
	p := &hostPlugin{
		h:           h,
		Environment: map[string]string{},
	}
